...
const getIcon = (name, color) => {
  switch (name) {
    ...
    case 'United-Kingdom':
      return (
        <>
          <g clipPath="url(#clip0_2293_5694)">
            <path
              d="M16 32C24.8366 32 32 24.8366 32 16C32 7.16344 24.8366 0 16 0C7.16344 0 0 7.16344 0 16C0 24.8366 7.16344 32 16 32Z"
              fill="#F0F0F0"
            />
            <path
              d="M3.30709 6.25879C2.05028 7.89398 1.10259 9.77866 0.550781 11.8261H8.87441L3.30709 6.25879Z"
              fill="#0052B4"
            />
            <path
              d="M31.4485 11.826C30.8967 9.77866 29.9489 7.89398 28.6922 6.25879L23.125 11.826H31.4485Z"
              fill="#0052B4"
            />
            <path
              d="M0.550781 20.1743C1.10266 22.2217 2.05034 24.1064 3.30709 25.7415L8.87422 20.1743H0.550781Z"
              fill="#0052B4"
            />
            <path
              d="M25.7411 3.30764C24.1059 2.05083 22.2213 1.10314 20.1738 0.55127V8.87483L25.7411 3.30764Z"
              fill="#0052B4"
            />
            <path
              d="M6.25879 28.6926C7.89398 29.9494 9.77866 30.8971 11.826 31.449V23.1255L6.25879 28.6926Z"
              fill="#0052B4"
            />
            <path
              d="M11.826 0.55127C9.7786 1.10314 7.89391 2.05083 6.25879 3.30758L11.826 8.87477V0.55127Z"
              fill="#0052B4"
            />
            <path
              d="M20.1738 31.449C22.2212 30.8971 24.1059 29.9494 25.741 28.6927L20.1738 23.1255V31.449Z"
              fill="#0052B4"
            />
            <path
              d="M23.125 20.1743L28.6922 25.7416C29.9489 24.1064 30.8967 22.2217 31.4485 20.1743H23.125Z"
              fill="#0052B4"
            />
            <path
            ...
            />
            <path
              d="M11.8263 20.1738H11.8262L4.68652 27.3135C5.01477 27.6419 5.35796 27.9551 5.71371 28.254L11.8263 22.1413V20.1738Z"
              fill="#D80027"
            />
            <path
              d="M11.8263 11.826V11.8258L4.68659 4.68604C4.35822 5.01429 4.04497 5.35747 3.74609 5.71322L9.85878 11.8259H11.8263V11.826Z"
              fill="#D80027"
            />
            <path
